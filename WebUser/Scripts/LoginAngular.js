...
var urlport = "http://localhost:58035/Login/";
...
app.controller("myCtrl1", function ($scope, $http) {
    ...
    $scope.ValidateData = function () {
        ...
        if (($scope.UserEmail == undefined) || (!emailRegex.test($scope.UserEmail))) {
            document.getElementById('emailvalidation').innerText = "Digite un Correo Invalido!";
        ...
        document.getElementById('passwordvalidation').innerText = "Digite una contraseña";
    ...
    $scope.LoginUser = function () {
        ...
        $scope.User.Username = $scope.UserPassword;
        $http({
            method: "post",
            url: urlport  + "Login_User",
            datatype: "json",
